...
cp "${FINDER_APP_DIR}/libm-2.31.so" "${OUTDIR}/rootfs/lib64"
cp "${FINDER_APP_DIR}/libm.so.6" "${OUTDIR}/rootfs/lib64"
cp "${FINDER_APP_DIR}/libresolv-2.31.so" "${OUTDIR}/rootfs/lib64"
cp "${FINDER_APP_DIR}/libresolv.so.2" "${OUTDIR}/rootfs/lib64"
cp "${FINDER_APP_DIR}/libc-2.31.so" "${OUTDIR}/rootfs/lib64"
